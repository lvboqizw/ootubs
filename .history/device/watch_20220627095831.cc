...
void Watch::epilogue(){
    guarded_scheduler.Scheduler::resume();   //can't directly call the resume from guarded_scheduler: 
                                            //if simply call the resume from the guard, it will run the guard.enter() and guard.leave()
